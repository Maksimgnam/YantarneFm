  ...
  return (
    <div className='w-full h-full flex items-center justify-center'>
        <div className='w-72 h-auto mb-4'>
            ...
            <input type="text" className='w-full h-14 border border-[#F94D4D] rounded-lg pl-3 text-white placeholder:text-white outline-none font-medium m-2 ml-0 mr-0' placeholder='Email'/>
            <input type="text" className='w-full h-14 border border-[#F94D4D] rounded-lg pl-3 text-white placeholder:text-white outline-none font-medium m-2 ml-0 mr-0'  placeholder='Пароль'/>
