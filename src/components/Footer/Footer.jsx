  ...
  return (
    <footer className='w-full h-auto  bg-[#252525]'>
      ...
      <div className='w-full h-auto flex flex-col justify-center  items-center p-12'>
        ...
        <p  className='text-center md:text-3xl text-md font-semibold  m-5 ml-0 mr-0'><span className='text-[#Cc0100] '>Якщо</span> у вас є новина, якою хочете поділитися - надсилайте нам, якщо ви <br /> хочете стати частинкою команди або маєте класні ідеї - пишіть нам. <br /> Якщо у вас виникли запитання стосовно реклами та співпраці - телефонуйте!</p>
